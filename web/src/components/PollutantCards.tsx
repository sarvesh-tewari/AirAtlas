    ...
    <section>
      <div className="mb-1">
        <SectionTitle
          ...
          color="#0284c7"
          eyebrow="In the air"
          info="The individual concentrations behind the AQI; the dominant pollutant (the one setting the index) is highlighted. Units µg/m³, CO in mg/m³."
        >
          Pollutants
        </SectionTitle>
      </div>
        ...
        {pollutants.map((p) => (
          ...
          >
            <div className="flex items-center justify-between">
              ...
              {p.dominant && (
                <span className="text-[10px] uppercase tracking-wide text-accent-text">dom</span>
              )}
            </div>
            <div className="mt-1 font-display text-2xl text-heading">
